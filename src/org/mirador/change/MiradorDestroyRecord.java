/* --------------------------------------------------------------------------+
   MiradorDestroyRecord.java - Representation of a tool-neutral model change
     log record that documents the destruction of a model element.
 ...
 */
public class MiradorDestroyRecord extends MiradorRecord {
  //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ constructors
  /**
   * Naked constructor for creating an empty destruction type of model change
   ...
   */
  public MiradorDestroyRecord(String element_id, String field_name,
      String new_value, String old_value,
      MergeSide merge_side, MiradorTransaction tx_action) {
  ...
  /**
   * Fujaba recorder-specific constructor for creating a destruction type of
   * model change record. Performs the conversion to tool-neutrality.
   *
   * @param  fujaba_record  The Fujaba model change log record.
   * @param  tx_action  Change transaction the operation is part of.
   */
  public MiradorDestroyRecord(FujabaChangeRecord fujaba_record,
