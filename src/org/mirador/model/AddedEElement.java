/* --------------------------------------------------------------------------+
   AddedEElement.java - Interface for the Changed metaclasses of the Ecore
...
/**
 * Empty interface to ease type checking of Added metaclasses of the MMD.
 *
 * @since   v0.65 - Nov 18, 2010
 * @author  Stephen Barrett
 */
public interface AddedEElement extends MMDEElement {
}
